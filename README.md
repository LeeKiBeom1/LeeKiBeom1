...
### 사용자의 불편함을 해결하는 서비스를 만드는 개발자입니다.
...
- 🤖 Computer Vision 및 AI 프로젝트 구현
- 🎲 YOLOv11 기반 Yacht Dice 자동 점수 계산 시스템 개발
...
> YOLOv11을 활용하여 주사위를 실시간으로 인식하고
> 자동으로 점수를 계산하는 Computer Vision 프로젝트
